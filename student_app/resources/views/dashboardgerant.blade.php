...
<br>
    <div><strong>
            <h3 class="bord">Bienvenue sur votre tableau de bord</h3>
        </strong></div>
    <div>
        <x-slot name="header">
        </x-slot>
    ...
    <div class="dg">
        <div class="cadretableau bg-body rounded shadow-sm ">
            <p class="pb-3 mb-0 small lh-sm border-bottom">
                ...
                <div class="categorie">
                <a href="cat">
                    <h4 class=" btn btn-secondary "> Créer une catégorie</h4>
                </a>
                </div>
                <a href=" ajp">
                    <h4 class="btn btn-info">Ajouter un produit</h4>
                </a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="positionaction">
                                <a class="btn btn-info" href="{{url('modif/'.$produit->id)}}">Modifier</a>
